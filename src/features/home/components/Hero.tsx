  ...
  return (
    <section className="flex flex-col gap-8">
      <div className="flex flex-col md:flex-row md:items-stretch gap-8 md:gap-12">
        <div className="relative w-52 max-md:h-80 md:w-64 flex-shrink-0 group">
        ...
        <div className="flex flex-col gap-4 flex-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground/60 mt-1 tracking-wide">
            Sporty · Traveler · Simple things lover
          </p>
      ...
      {children && (
        <div className="flex flex-col gap-8 md:ml-[19rem]">{children}</div>
      )}
    </section>
  );
}
